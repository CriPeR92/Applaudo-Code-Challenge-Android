...
class DetailsViewModel(application: Application, private val animeRepository: AnimeRepository, val sharedPreferencesRepository: SharedPreferencesRepository)
